...
import {
  PendingOnlineReqToolBarComponent
} from './inner-items/pending-online-req-tool-bar/pending-online-req-tool-bar.component';
import {ViewMedicalRequestComponent} from '../view-medical-request/view-medical-request.component';

@Component({
  selector: 'app-pending-online-medical-requests',
  imports: [
    FormsModule,
    // InputText,
    ButtonDirective,
  ...
  templateUrl: './pending-online-medical-requests.component.html',
  styleUrl: './pending-online-medical-requests.component.scss',
  standalone:true
})
export class PendingOnlineMedicalRequestsComponent implements OnInit {
