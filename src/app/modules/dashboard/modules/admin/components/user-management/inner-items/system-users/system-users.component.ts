...
import {NewUserComponent} from './inner-items/new-user/new-user.component';
import {ViewUserLogComponent} from './inner-items/view-user-log/view-user-log.component';
...
import {UpdateUserComponent} from './inner-items/update-user/update-user.component';
import {
  DeleteDialogContentComponent
} from '../../../../../../../../components/delete-dialog-content/delete-dialog-content.component';
import {SystemUserToolBarComponent} from './inner-items/system-user-tool-bar/system-user-tool-bar.component';

import {AdminService} from '../../../../../../../../services/admin/admin.service';
import {TruncatePipe} from '../../../../../../../../pipe/truncate.pipe';
import {ViewUserComponent} from './inner-items/view-user/view-user.component';
import {AttachRolesToAdminComponent} from './inner-items/attach-roles-to-admin/attach-roles-to-admin.component';
...
export class SystemUsersComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.admins= [
      {fullName:'Ashen Manilka', userName:'ashen@gmail.com'},
      {fullName:'Rasika Jeewantha', userName:'rasika@gmail.com'}
    ]
  }
