...
import {AllClientsToolBarComponent} from './inner-items/all-clients-tool-bar/all-clients-tool-bar.component';
import {UpdateClientComponent} from './inner-items/update-client/update-client.component';
...
export class AllClientsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.roles = [
      {username:'ashen manilka',email:'ashen@gmail.com'},
      {username:'chamath devinda',email:'chamath@gmail.com'},
