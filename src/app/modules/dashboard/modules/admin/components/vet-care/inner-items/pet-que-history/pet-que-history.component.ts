...
import {QueHistoryToolbarComponent} from './inner-items/que-history-toolbar/que-history-toolbar.component';

@Component({
  selector: 'app-pet-que-history',
  imports: [
    FormsModule,
    // InputText,
    ButtonDirective,
    ...
    Tooltip,
    TruncatePipe,
    QueHistoryToolbarComponent
  ],
  templateUrl: './pet-que-history.component.html',
  styleUrl: './pet-que-history.component.scss',
  standalone:true
})
export class PetQueHistoryComponent implements OnInit {
