...
import {MedicalQueueToolBarComponent} from './inner-items/medical-queue-tool-bar/medical-queue-tool-bar.component';


@Component({
  selector: 'app-medical-que-list',
  imports: [
    FormsModule,
    // InputText,
    ButtonDirective,
    ...
    Tooltip,
    TruncatePipe,
    MedicalQueueToolBarComponent
  ],
  templateUrl: './medical-que-list.component.html',
  styleUrl: './medical-que-list.component.scss',
  standalone:true
})
export class MedicalQueListComponent implements OnInit {
